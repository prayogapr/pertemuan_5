      ...
      children: [
        ...
        CircleAvatar(
          backgroundImage: NetworkImage(
            user.profileImage ??
                "https://i.postimg.cc/4NWjhxTz/61698c7aece86.jpg",
          ),
        ),
      ],
    );
                          ...
                          children: [
                            ...
                            const Expanded(
                              child: Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                  "Partai Demokrasi Indonesia Perjuangan adalah sebuah partai politik Indonesia, dan partai dari Presiden Indonesia saat ini, Joko Widodo. PDI-P saat ini dipimpin oleh Megawati Soekarnoputri, Presiden Kelima Indonesia dan merupakan putri dari Presiden Pertama Indonesia Soekarno.",
                                  maxLines: 3,
                                ),
                              ),
                            ),
